package com.tatiana.gitworkflow;
...
public class GitWorkflow {
    public static void main(String[] args) {
        ...
        String step3a= "Perform git pull command - to fetch and download content from the origin/master and immediately update" +
                "the local master to match that content";
        ...
        String step6 = "Review you changes and check you code before committing them";
        ...
        String step9 = "The committed changes are pushed to an origin branch with the same name, navigate to GitHub branch";
